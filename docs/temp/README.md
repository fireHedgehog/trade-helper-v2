...
**Frozen conclusions live in [`../strategy-experiments/naive-donchian-v1-result.md`](../strategy-experiments/naive-donchian-v1-result.md).**
...
is precise — this is an app. Every number in `../strategy-experiments/naive-donchian-v1-result.md` is
...
`../strategy-experiments/naive-donchian-v1-result.md`, then delete the scratch. Contents of this folder are
