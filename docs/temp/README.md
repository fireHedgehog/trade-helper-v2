...
**Frozen conclusions live in [`../strategy-experiments/result.md`](../strategy-experiments/result.md).**
...
is precise — this is an app. Every number in `../strategy-experiments/result.md` is
...
`../strategy-experiments/result.md`, then delete the scratch. Contents of this folder are
