...
| Next implementation task | APP02: visible market structure and location; then APP03–APP04 deliver trend/channel/range setups in both directions. Do not redo SMA. |
...
| APP02 | [ ] proposed | Structure and location on charts | Existing bars/charts; playbook §§3, 8 | Confirmed HH/HL/LH/LL and protected levels; UP/DOWN/RANGE/TRANSITION/UNKNOWN; anchored zones/channels and high/middle/low labels; reasons and unavailable cases visible. |
...
| APP11 | [ ] proposed | Discretionary C/B/A sizing | APP10 | Editable base lot and grade multipliers, cash basis, stop-risk/exposure limits, trader override and clear arithmetic. No calibration exercise required. |
...
| APP13 | [ ] deferred | Neutral defined-risk options planner | Actual options data/instrument support | Named setup with legs, quotes, expiry, payoff, cost and management rules. A neutral chart does not automatically mean sell volatility. |
