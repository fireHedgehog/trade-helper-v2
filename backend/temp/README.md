...
**Frozen conclusions live in [`../../docs/strategy-experiments/`](../../docs/strategy-experiments/).**
...
conclusions in `docs/strategy-experiments/` are hardcoded and self-contained.
