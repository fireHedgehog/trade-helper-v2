...
**Frozen conclusions live in [`../../docs/strategy-experiments/naive-donchian-v1-result.md`](../../docs/strategy-experiments/naive-donchian-v1-result.md).**
...
conclusions in `docs/strategy-experiments/naive-donchian-v1-result.md` are hardcoded and self-contained.
